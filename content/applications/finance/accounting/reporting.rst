...
**XLSX** format by clicking :guilabel:`PDF` or :guilabel:`XLSLX` at the top of the page.

.. image:: reporting/reporting-annotate.png
   :alt: Annotate reports.

You can compare values across periods. Go to the :guilabel:`Comparison` menu and select the periods
you want to compare.
...
- **Position:**
    ...
    - **Current assets to liabilities:**
        ...
        be due in the next year). It is typically used to measure a company's ability to service its
        debt.
